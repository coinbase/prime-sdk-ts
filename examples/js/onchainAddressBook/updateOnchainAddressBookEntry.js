 ...
 *
 * Usage:
 *   node examples/js/onchainAddressBook/updateOnchainAddressBookEntry.js [id] [name] [networkType] [addressName] [address] [chainIds]
 *
 * Examples:
 *   node examples/js/onchainAddressBook/updateOnchainAddressBookEntry.js abc123-def456 UpdatedGroup NETWORK_TYPE_EVM UpdatedWallet 0x742...abc 1,8453
 *   node examples/js/onchainAddressBook/updateOnchainAddressBookEntry.js xyz789-ghi012 SolanaGroupUpdated NETWORK_TYPE_SOLANA UpdatedSolWallet 9WzDX...789 101
 *
...
if (!id) {
  ...
  console.error(
    'Usage: node examples/js/onchainAddressBook/updateOnchainAddressBookEntry.js <id> [name] [networkType] [addressName] [address] [chainIds]'
  );
  return;
}
