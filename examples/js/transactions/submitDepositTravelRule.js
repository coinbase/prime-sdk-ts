 ...
 *
 * Usage:
 *   node examples/js/transactions/submitDepositTravelRule.js [transactionId]
 *
 * Examples:
 *   node examples/js/transactions/submitDepositTravelRule.js abc123-def456-ghi789
 *
...
if (!transactionId) {
  ...
  console.error(
    'Usage: node examples/js/transactions/submitDepositTravelRule.js [transactionId]'
  );
  return;
}
