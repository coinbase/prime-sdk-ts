 ...
 *
 * Usage:
 *   node examples/js/transactions/createWithdrawal.js [walletId] [amount] [currencySymbol] [destinationType] [destination]
 *
 * Examples:
 *   node examples/js/transactions/createWithdrawal.js abc123-def456 1.5 BTC BLOCKCHAIN_ADDRESS 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa
 *   node examples/js/transactions/createWithdrawal.js wallet-id 1000 USDC PAYMENT_METHOD payment-method-id
 *
...
if (!walletId) {
  ...
  console.error(
    'Usage: node examples/js/transactions/createWithdrawal.js [walletId] [amount] [currencySymbol] [destinationType] [destination]'
  );
  return;
}
