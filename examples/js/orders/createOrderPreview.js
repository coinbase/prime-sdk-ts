 ...
 *
 * Usage:
 *   node examples/js/orders/createOrderPreview.js [productId] [side] [type] [baseQuantity] [limitPrice]
 *
 * Examples:
 *   node examples/js/orders/createOrderPreview.js BTC-USD BUY LIMIT 0.1 120000
 *   node examples/js/orders/createOrderPreview.js ETH-USD SELL MARKET 1.0
 *
