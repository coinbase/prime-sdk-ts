...
export enum UpdateFundingSettingsBadRequestSubcode {
  /**
  ...
  /**
   * The excess_funds_target_amount field is missing, is not a valid decimal number, or is negative.
   *
   * Error code: VALIDATION_ERROR (HTTP 400)
   */
  FundingSettingsExcessTargetAmountInvalid = 'FUNDING_SETTINGS_EXCESS_TARGET_AMOUNT_INVALID',
}
