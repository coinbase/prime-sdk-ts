...
export enum GetEntityActivitiesForbiddenSubcode {
  /**
  ...
  /**
   * You do not have permission to access the requested activity data for the given entity or portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  ActivityAccessDenied = 'ACTIVITY_ACCESS_DENIED',
}
