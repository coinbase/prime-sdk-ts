...
export enum GetCrossMarginRiskParametersForbiddenSubcode {
  /**
  ...
  /**
   * Cross margin is not enabled for the requested entity.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  CrossMarginNotEnabled = 'CROSS_MARGIN_NOT_ENABLED',
}
