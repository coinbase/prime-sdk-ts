...
export enum ListAdvancedTransferTransactionsForbiddenSubcode {
  /**
  ...
  /**
   * Advanced Transfers are not enabled for this portfolio, or the specific transfer configuration requested is not enabled for this portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  AdvancedTransferNotEnabled = 'ADVANCED_TRANSFER_NOT_ENABLED',
}
