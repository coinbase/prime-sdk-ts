...
export enum CreateQuoteRequestForbiddenSubcode {
  /**
  ...
  /**
   * This portfolio is not allowed to submit RFQ (request-for-quote) requests.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  OrderRfqNotEnabled = 'ORDER_RFQ_NOT_ENABLED',
  /**
   * Size-in-quote RFQ requests are not enabled for this portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  OrderRfqSiqNotEnabled = 'ORDER_RFQ_SIQ_NOT_ENABLED',
}
