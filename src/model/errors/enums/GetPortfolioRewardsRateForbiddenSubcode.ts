...
export enum GetPortfolioRewardsRateForbiddenSubcode {
  /**
  ...
  /**
   * The Rewards Rate API is not enabled for this entity or portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  RewardsApiFeatureDisabled = 'REWARDS_API_FEATURE_DISABLED',
}
