...
export enum OrderPreviewBadRequestSubcode {
  ...
  /**
   * Orders of type BLOCK cannot be created or previewed through this endpoint.
   *
   * Error code: VALIDATION_ERROR (HTTP 400)
   */
  OrderTypeBlockUnsupported = 'ORDER_TYPE_BLOCK_UNSUPPORTED',
  /**
   * Orders of type RFQ cannot be created or previewed through this endpoint. Use the RFQ (/rfq) and accept quote (/accept_quote) endpoints instead.
   *
   * Error code: VALIDATION_ERROR (HTTP 400)
   */
  OrderTypeRfqUnsupported = 'ORDER_TYPE_RFQ_UNSUPPORTED',
  /**
   * The FILL_OR_KILL time-in-force is not enabled for this portfolio.
   *
   * Error code: VALIDATION_ERROR (HTTP 400)
   */
