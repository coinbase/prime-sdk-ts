...
export enum CreateConversionForbiddenSubcode {
  /**
  ...
  /**
   * You do not have permission to convert funds using the specified wallet_id or portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  ConversionPermissionDenied = 'CONVERSION_PERMISSION_DENIED',
}
