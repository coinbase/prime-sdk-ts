...
export enum GetPortfolioRewardsRateBadRequestSubcode {
  /**
  ...
  /**
   * The rewards rate request is invalid.
   *
   * Error code: VALIDATION_ERROR (HTTP 400)
   */
  RewardsRequestInvalid = 'REWARDS_REQUEST_INVALID',
  /**
   * The entity is not enrolled in Prime Rewards.
   *
   * Error code: FAILED_PRECONDITION (HTTP 400)
   */
  RewardsEntityNotEnrolled = 'REWARDS_ENTITY_NOT_ENROLLED',
}
