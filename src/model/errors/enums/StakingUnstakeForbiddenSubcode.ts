...
export enum StakingUnstakeForbiddenSubcode {
  /**
  ...
  /**
   * Wallet-level staking has not been enabled for this portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  StakingNotEnabled = 'STAKING_NOT_ENABLED',
  /**
   * The validator_allocations field is not enabled for this portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  StakingValidatorAllocationsNotEnabled = 'STAKING_VALIDATOR_ALLOCATIONS_NOT_ENABLED',
}
