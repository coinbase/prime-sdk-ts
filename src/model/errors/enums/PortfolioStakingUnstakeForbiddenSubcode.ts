...
export enum PortfolioStakingUnstakeForbiddenSubcode {
  /**
  ...
  /**
   * Provider-level unstaking (unstaking all validators for a given validator_provider) is not enabled for this portfolio.
   *
   * Error code: PERMISSION_DENIED (HTTP 403)
   */
  StakingProviderUnstakeNotEnabled = 'STAKING_PROVIDER_UNSTAKE_NOT_ENABLED',
}
